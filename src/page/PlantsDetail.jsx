...
function PlantsDetail() {
  ...
  return (
    <div className="min-h-screen py-20 animate-fade-in bg-[#e9ffe664]">
      {" "}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <Link
            to="/plants"
            className="text-muted-foreground hover:text-primary transition-colors bg-white p-5 rounded-xl hover:bg-[#8fef9a] transition-all "
          >
            ← العودة إلى النباتات
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16 ">
          <div className="relative rounded-3xl h-96 overflow-hidden glass-effect premium-shadow">
            ...
            {plant.badge && (
              <span
                className={`absolute top-6 right-6 ${plant.badgeColor} text-white px-4 py-2 text-sm`}
              >
                {plant.badge}
              </span>
            )}
          ...
          <div className="flex flex-col justify-center ">
            ...
            <span className="w-fit mb-4 text-base px-4 py-2 bg-[#ee9b02] hover:bg-[#e8a527] rounded-2xl">
              مستوى الصعوبة: {plant.difficulty}
            </span>

            <div className="grid grid-cols-2 gap-4 mt-6 opacity-90">
              <div className="p-4  rounded-2xl bg-white border-gray-200 border-2">
        ...
        <div>
          <div className="  ">
            <button className="px-8 py-3  rounded-2xl  bg-[#8fef9a] ">
              نظرة عامة
            </button>
          </div>
          <div className="p-8  rounded-2xl border-gray-200 border-2 mt-6 bg-white glass-effect premium-shadow">
